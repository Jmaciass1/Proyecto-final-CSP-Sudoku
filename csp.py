...
# Esta clase fue extraída de https://github.com/aimacode/aima-python/ modificandola ligeramente para 
# una correcta adaptación a nuestro código, omtiendo lineas que sobraban en este punto
